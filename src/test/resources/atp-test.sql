...
INSERT INTO public.test_case_table(
  ...
  ('4d203173-5555-4f62-aabb-8ebcec357f87','Instantiate Application','','sandboxTest','org.edgegallery.atp.schedule.testcase.sandbox.InstantiateAppTestCase','Instantiate application and its dependency application on one edge host','','java','app can instantiate successfully.','EdgeGallery,Mobile'),
  ('4d203173-6666-4f62-aabb-8ebcec357f87','UnInstantiate Application','','sandboxTest','org.edgegallery.atp.schedule.testcase.sandbox.UninstantiateAppTestCase','Uninstantiate application and its dependency application on one edge host','','java','app can uninstantiate successfully.','EdgeGallery,Mobile'),
  ...
  ('4d203173-8888-4f62-aabb-8ebcec357f87','Bomb Defense','','securityTest','BombDefenseTestCase','bomb defense','','java','no bomb defense.','EdgeGallery,Mobile');
