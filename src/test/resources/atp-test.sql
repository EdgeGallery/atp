    ...
    VALUES('4353982a-abb0-4cf6-9cae-a468a5318c67','虚机应用实例化','vm app instantiation','用于虚机应用实例化的参数','params used for vm app instantiation','DC_ID=FS_M:Manger_VPC;az_dc=nova;ak=;sk=;mep_certificate=;app_mp1_ip=192.168.226.235;app_mp1_mask=255.255.255.0;app_mp1_gw=192.168.226.4;app_n6_ip=192.168.225.80;app_n6_mask=255.255.255.0;app_n6_gw=192.168.225.3;app_internet_ip=192.168.227.25;app_internet_mask=255.255.255.0;app_internet_gw=192.168.227.2;mep_ip=119.8.47.5;mep_port=8443;network_name_mep=mec_network_mep;network_mep_physnet=physnet2;network_mep_vlanid=2663;network_name_n6=mec_network_n6;network_n6_physnet=physnet2;network_n6_vlanid=2662;network_name_internet=mec_network_internet;network_internet_physnet=physnet2;network_internet_vlanid=2661;ue_ip_segment=150.30.1.0/24', now()::timestamp without time zone);
    ...
    INSERT INTO public.test_case_table(
         id, nameCh,nameEn,configIdList, hashCode,type, classname,  descriptionCh,descriptionEn,filePath,codeLanguage,expectResultCh,expectResultEn,testStepCh,testStepEn,testSuiteIdList,createTime)
