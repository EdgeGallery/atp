...
package org.edgegallery.atp.infrastructure.persistence.comment;

import java.util.List;
import java.util.stream.Collectors;
import org.edgegallery.atp.domain.model.comment.Comment;
import org.edgegallery.atp.domain.model.comment.CommentHistory;
...
public class CommentRepositoryImpl implements CommentRepository {
    ...
    public Page<Comment> findAllWithPagination(PageCriteria pageCriteria) {
        long total = Long.valueOf(commentMapper.countTotal(pageCriteria));
