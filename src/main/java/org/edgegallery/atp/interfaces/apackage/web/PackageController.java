...
package org.edgegallery.atp.interfaces.apackage.web;
...
import org.edgegallery.atp.interfaces.apackage.facade.PackageServiceFacade;
...
public class PackageController {
    ...
    @RequestMapping(value = "/apps/{appId}/packages/{packageId}", method = RequestMethod.DELETE,
    ...
    @RequestMapping(value = "/apps/{appId}/packages/{packageId}", method = RequestMethod.GET,
        produces = MediaType.APPLICATION_JSON)
    ...
    @RequestMapping(value = "/apps/{appId}/packages/{packageId}/action/download", method = RequestMethod.GET,
    ...
    @RequestMapping(value = "/apps/{appId}/packages/{packageId}/files", method = RequestMethod.POST,
        produces = MediaType.APPLICATION_JSON)
