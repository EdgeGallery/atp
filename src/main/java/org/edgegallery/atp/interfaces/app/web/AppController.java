...
package org.edgegallery.atp.interfaces.app.web;
...
import org.edgegallery.atp.interfaces.apackage.facade.dto.PackageDto;
import org.edgegallery.atp.interfaces.app.facade.AppParam;
import org.edgegallery.atp.interfaces.app.facade.AppServiceFacade;
import org.edgegallery.atp.interfaces.app.facade.dto.AppDto;
...
public class AppController {
    ...
    public ResponseEntity<String> appRegistering(@RequestParam("userId") @Pattern(regexp = REG_USER_ID) String userId,
        ...
        @ApiParam(value = "app type", required = true)  @Length(max = MAX_DETAILS_STRING_LENGTH)
        @NotNull(message = "type should not be null.") @RequestPart("type") String type,
        @ApiParam(value = "app shortDesc") @Length(max = MAX_DETAILS_STRING_LENGTH)
        @RequestPart("shortDesc") String shortDesc,
        @ApiParam(value = "app affinity", required = true) @Length(max = MAX_DETAILS_STRING_LENGTH)
        @NotNull(message = "affinity should not be null.") @RequestPart("affinity") String affinity,
        @ApiParam(value = "app industry", required = true) @Length(max = MAX_DETAILS_STRING_LENGTH)
        @NotNull(message = "industry should not be null.") @RequestPart("industry") String industry)
            throws IOException {
