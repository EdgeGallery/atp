...
package org.edgegallery.atp.interfaces.comment;
...
import org.edgegallery.atp.interfaces.comment.facade.CommentServiceFacade;
...
public class CommentController {
    ...
    @RequestMapping(value = "/apps/{appId}/comments", method = RequestMethod.POST,
    ...
    @RequestMapping(value = "/apps/{appId}/comments", method = RequestMethod.GET,
        produces = MediaType.APPLICATION_JSON_VALUE)
